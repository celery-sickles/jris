...
Traffic accident analysis is an important subsection of traffic management. Traffic accident modeling utilizes traffic accident
data to determine when and where traffic accidents will occur. City planners rely on accurate traffic accident data to
make policy and planning decisions that can decrease traffic accidents. For example, [throw in an example of how policymakers use traffic
...
\section{Background}
Traffic modeling has a long history of data-driven models that have been used to make planning decisions.
